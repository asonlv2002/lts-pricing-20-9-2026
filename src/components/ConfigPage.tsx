...
export default function ConfigPage() {
  ...
  const handleInkPriceChange = (name: string, val: number) => {
    ...
    materials.forEach(m => {
      if (m.name === name) {
        setMaterialParam(m.id, { inkPricePerColor: val });
      }
    });
  };
  ...
  const handleReset = () => {
    ...
    resetKeys.forEach(key => {
      setConstantParam(key, INITIAL_CONSTANTS[key] as number);
    });
    // Reset colorSetup
    Object.keys(INITIAL_CONSTANTS.colorSetup).forEach(k => {
      const numK = Number(k);
      if (constants.colorSetup[numK] !== INITIAL_CONSTANTS.colorSetup[numK]) {
        setConstantParam('colorSetup', { ...INITIAL_CONSTANTS.colorSetup } as any);
      }
    });
  };
  ...
  const handleColorSetupChange = (colorNum: number, val: number) => {
    ...
    setConstantParam('colorSetup' as any, newSetup as any);
  };
                ...
                <tbody>
                  {materials.map((m, idx) => (
                    <tr key={m.id}>
                      ...
                      <td>{m.density}</td>
                      <td><input type="number" className="config-inline-input" value={m.thickness} onChange={(e) => setMaterialParam(m.id, { thickness: parseFloat(e.target.value)||0 })} style={{width:'80px', textAlign:'right'}} /></td>
                      <td><input type="number" className="config-inline-input" value={m.pricePerKg} onChange={(e) => setMaterialParam(m.id, { pricePerKg: parseFloat(e.target.value)||0 })} style={{width:'100px', textAlign:'right', fontWeight:700}} /></td>
                    ...
                    <th style={{paddingBottom: '8px'}}>
                      ...
                      <span style={{fontSize:'0.8rem', fontWeight:'normal', textTransform:'none'}}>
                        (CD / <input type="number" className="config-inline-input" style={{width:'75px', margin:'0 4px', padding:'4px', fontWeight:700}}
                          ...
                          onChange={(e) => setConstantParam('printWasteA', parseFloat(e.target.value) || 6000)}
                        /> × B)
                      </span>
                    </th>
                    <th style={{paddingBottom: '8px'}}>
                      ...
                      <input type="number" className="config-inline-input" style={{width:'75px', margin:'0 4px', padding:'4px', fontWeight:700}}
                        ...
                        onChange={(e) => setConstantParam('printWasteC', parseFloat(e.target.value) || 50000)}
                      /> m<br/>
                      ...
                      <td style={{textAlign:'center', verticalAlign:'middle'}}>
                        <div style={{display:'flex', justifyContent:'center', alignItems:'center', gap:'8px'}}>
                          ...
                          <input type="number" className="config-inline-input" style={{width:'75px'}}
                            ...
                            onChange={(e) => setConstantParam('printWasteB', parseFloat(e.target.value) || 40)} />
                        </div>
                      </td>
                      <td style={{textAlign:'center', verticalAlign:'middle'}}>
                        <div style={{display:'flex', justifyContent:'center', alignItems:'center', gap:'8px'}}>
                          ...
                          <input type="number" className="config-inline-input" style={{width:'75px'}}
                            ...
                            onChange={(e) => setConstantParam('printWasteD', parseFloat(e.target.value) || 400)} />
                        </div>
                      </td>
                    </tr>
                  ))}
          ...
          <div className="card config-card">
            ...
            <div className="config-cpsx-grid">
              <div className="config-cpsx-item">
                ...
                <input type="number" className="form-input" value={constants.nhuPrice} onChange={e => setConstantParam('nhuPrice', parseFloat(e.target.value)||0)} />
              </div>
              <div className="config-cpsx-item">
                <label>Giá phủ mờ (đ)</label>
                <input type="number" className="form-input" value={constants.moPrice} onChange={e => setConstantParam('moPrice', parseFloat(e.target.value)||0)} />
              </div>
            </div>
          ...
          <div className="card config-card">
            ...
            <div className="config-cpsx-grid">
              <div className="config-cpsx-item">
                ...
                <input type="number" className="form-input" value={constants.laborCost} onChange={e => setConstantParam('laborCost', parseFloat(e.target.value)||0)} />
              </div>
            </div>
            ...
            <div className="config-table-wrap" style={{marginTop:'12px'}}>
              <table className="config-table">
                ...
                <tbody>
                  <tr>
                    <td>Nhỏ</td>
                    <td><input type="number" className="config-inline-input" value={constants.cutThreshold1} step="0.01" onChange={e => setConstantParam('cutThreshold1', parseFloat(e.target.value)||0)} /></td>
                    <td><input type="number" className="config-inline-input" value={constants.cutMult1} step="0.1" onChange={e => setConstantParam('cutMult1', parseFloat(e.target.value)||0)} /></td>
                    <td className="cut-preview">{(constants.cutBase * constants.cutMult1).toLocaleString('vi-VN', {maximumFractionDigits:0})}</td>
                  </tr>
                  <tr>
                    <td>Trung bình</td>
                    <td><input type="number" className="config-inline-input" value={constants.cutThreshold2} step="0.01" onChange={e => setConstantParam('cutThreshold2', parseFloat(e.target.value)||0)} /></td>
                    <td><input type="number" className="config-inline-input" value={constants.cutMult2} step="0.1" onChange={e => setConstantParam('cutMult2', parseFloat(e.target.value)||0)} /></td>
                    <td className="cut-preview">{(constants.cutBase * constants.cutMult2).toLocaleString('vi-VN', {maximumFractionDigits:0})}</td>
                  </tr>
                  <tr>
                    <td>Lớn</td>
                    <td>—</td>
                    <td><input type="number" className="config-inline-input" value={constants.cutMult3} step="0.1" onChange={e => setConstantParam('cutMult3', parseFloat(e.target.value)||0)} /></td>
            ...
            <div className="config-table-wrap">
              <table className="config-table">
                ...
                <tbody>
                  <tr>
                    <td>Zipper</td>
                    <td><input type="number" className="config-inline-input" style={{width:'80px',textAlign:'right',fontWeight:700, background:'transparent'}} value={constants.zipperPrice} onChange={e => setConstantParam('zipperPrice', parseFloat(e.target.value)||0)} /> đ/m</td>
                    <td><input type="number" className="config-inline-input" style={{width:'80px',textAlign:'right',fontWeight:700, background:'transparent'}} value={constants.zipperWeight} step="0.1" min="0" onChange={e => setConstantParam('zipperWeight', parseFloat(e.target.value)||0)} /> Gr/m</td>
                  </tr>
                  <tr>
                    <td>Băng keo</td>
                    <td><input type="number" className="config-inline-input" style={{width:'80px',textAlign:'right',fontWeight:700, background:'transparent'}} value={constants.tapePrice} onChange={e => setConstantParam('tapePrice', parseFloat(e.target.value)||0)} /> đ/m</td>
                    <td><input type="number" className="config-inline-input" style={{width:'80px',textAlign:'right',fontWeight:700, background:'transparent'}} value={constants.tapeWeight} step="0.1" min="0" onChange={e => setConstantParam('tapeWeight', parseFloat(e.target.value)||0)} /> Gr/m</td>
                  </tr>
                  <tr>
                    <td>Quai</td>
                    <td><input type="number" className="config-inline-input" style={{width:'80px',textAlign:'right',fontWeight:700, background:'transparent'}} value={constants.handlePrice} onChange={e => setConstantParam('handlePrice', parseFloat(e.target.value)||0)} /> đ/cái</td>
                    <td><input type="number" className="config-inline-input" style={{width:'80px',textAlign:'right',fontWeight:700, background:'transparent'}} value={constants.handleWeight} step="0.1" min="0" onChange={e => setConstantParam('handleWeight', parseFloat(e.target.value)||0)} /> Gr/cái</td>
                  </tr>
                </tbody>
              </table>
            </div>
