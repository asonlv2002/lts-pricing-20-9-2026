 ...
 * TP: Đầu vào NVL = (SL×bước) ÷ (số con hình ÷ số phần tử chia) (fallback cutMeters).
 ...
 * `metChay` = metLamTuiTuDauVaoNVL(result) = TP+PH (TP = SL×bước ÷ (con hình ÷ phần tử chia)).
