  ...
  return (
    <ScrollView style={styles.cuon} contentContainerStyle={styles.noiDungCuon}>
      ...
      <View style={styles.the}>
        ...
        <View style={styles.khungPicker}>
          <Picker
            selectedValue={dauVao.loaiTruc ?? 'A'}
            onValueChange={(v) => capNhatDauVao({ loaiTruc: v as 'A' | 'B' | 'custom' })}
            style={styles.picker}
          >
            <Picker.Item label="Trục A" value="A" />
            <Picker.Item label="Trục B" value="B" />
            <Picker.Item label="Trục khác" value="custom" />
          </Picker>
        </View>
      ...
      <View style={styles.the}>
        ...
        <View style={styles.khungPicker}>
          <Picker
            selectedValue={dauVao.ngayThanhToan ?? 30}
            onValueChange={(v) => capNhatDauVao({ ngayThanhToan: v })}
            style={styles.picker}
          >
            <Picker.Item label="14 ngày" value={14} />
            <Picker.Item label="30 ngày" value={30} />
            <Picker.Item label="45 ngày" value={45} />
...
const styles = StyleSheet.create({
  ...
  khungPicker: {
    borderWidth: 1, borderColor: '#d1d5db', borderRadius: 8,
    backgroundColor: '#f9fafb', marginTop: 4, overflow: 'hidden',
  },
  picker: { height: 44 },
  hangSwitch: {
